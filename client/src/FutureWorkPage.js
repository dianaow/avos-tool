    ...
    <React.Fragment>
      ...
      <div className="App__wrapper">
        <div className='App_container-textonly'>
          ...
          <p>Future efforts could focus on developing an NLP model that can accurately and reliably map existent sustainability marketing research onto the A-VO-S Tool. This would make the mapping process more efficient as it removes the need for individual coders to physically read through extensive research papers, and also makes it more reliable as the process is more objective.</p>

          <b>Automating Mapping of Research Ideas/Professional Work </b>
          <p>Another area of the A-VO-S Tool that would benefit from automation would be in the piloted Try It Yourself part of the tool. Rather than users manually answering questions that place their work onto the map, automation here would use the same technology that automatically maps existent research to map novel work onto the map. This would be a further development of the first automation opportunity. </p>
