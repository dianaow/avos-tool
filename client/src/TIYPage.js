    ...
    <React.Fragment>
      ...
      <div className="App__wrapper">
        <div className ='SideBarLeft1'>
          <h4>Following this, you will be shown a simplified version of the codebook used by the researchers that allows you to get a rough idea of where your paper falls. However, if you’re interested in the nuance of your paper’s placement on the A-VO-S Tool, including the accurate Scope of Sustainability, please follow this link to the full codebook.</h4>
          ...
          <>
            <div style={{margin: '20px 0px', width: '50%'}}>
              <h4>How would you like to name your research in the A-VO-S Tool? </h4>
          ...
          <>
            <div style={{margin: '20px 0px', width: '50%'}}>
              <h4>How would you like to name your work in the A-VO-S Tool? </h4>
