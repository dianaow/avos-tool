    ...
    <React.Fragment>
      ...
      <div className="App__wrapper">
        <div className='App_container-textonly'>
          <h1>Our Process</h1>
          <p>There were several methodological steps involved in developing the A-VO-S Tool. First, we had to identify the dimensions that made up the theoretical framework of the A-VO-S Tool. After that, we had to develop a codebook to conduct the content analysis to map the empirical articles onto the A-VO-S Tool. Below, you can see a summarized explanation of how these steps were completed. </p>
          ...
          <b>A-VO-S Tool – Codebook Development & Mapping Empirical Articles </b>
